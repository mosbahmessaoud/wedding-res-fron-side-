// // D:\DEV\wedding_progect\wedding-reservation-V4-main\wedding-reservation-V4-main_2__7\frontend\lib\screens\auth\login_screen.dart
// import 'dart:async';
// import 'dart:convert';
// import 'dart:io';
...
//     // Double-check with actual internet access by pinging a reliable endpoint
//     try {
...
//     // If connectivity check fails, assume we have internet and let API call fail properly
//     return true;
//   }
// }
...
// //     // Attempt API login with appropriate timeout
...
// //     if (parts.length != 3) {
// //       throw Exception('تنسيق التوكن غير صالح');
// //     }
...
// //       throw Exception('دور المستخدم غير محدد');
// //     }
  
// //     // Save credentials for offline login
// //     await _saveLoginCredentials(phoneText, passwordText, role, token);
  
// //     // Start notification monitoring (don't block on failure)
// //     _startNotificationMonitoringAsync();
...
// //         break;
// //       default:
// //         throw Exception('دور المستخدم غير معروف: $role');
// //     }
...
// //     print('SocketException during login: $e');
// //     if (!mounted) return;
// //     setState(() => _isLoading = false);
// //     _showNoInternetDialog();
...
// //     print('FormatException during login: $e');
// //     if (!mounted) return;
// //     setState(() => _isLoading = false);
// //     _showErrorDialog('خطأ في معالجة البيانات. يرجى المحاولة مرة أخرى.');
// //   } catch (e) {
...
//   final phoneTextinit = _phoneController.text.trim();
//   String phoneText = phoneTextinit; // Default to input value

//   try {
//     // Try to find groom's actual phone number
//     phoneText = await ApiService.getGroomPhoneBySearch(phoneTextinit);
//     print('Found groom phone: $phoneText');
//   } catch (e) {
//     // If phone not found, show error and stop
//     if (!mounted) return;
//     setState(() => _isLoading = false);
...
//     print('✅✅✅✅✅✅Attempting login for phone: $phoneText');
//     // Attempt API login with appropriate timeout
//     final response = await ApiService.login(phoneText, passwordText)
//         .timeout(
...
// void _startNotificationMonitoringAsync() {
//   // Run notification monitoring in background without blocking login
