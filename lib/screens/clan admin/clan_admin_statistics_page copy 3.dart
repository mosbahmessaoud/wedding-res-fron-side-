...
//     // Build headers excluding internal __ keys
...
//           // ✅ parse days_remain for color logic
...
//             // 🔴 Red for outside-clan reservations
...
//               );
//             }
//             // ✅ Color-code "صلاحية الوثيقة" column
//             else if (colName == 'صلاحية الوثيقة') {
//               cell.value = excel_lib.TextCellValue(row[colName]?.toString() ?? '—');
//               if (daysRemainInt == null) {
//                 // no expiry set — neutral, no special color
