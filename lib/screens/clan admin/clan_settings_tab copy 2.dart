...
//   double _currentPayment = 0.0; // To store the fetched payment
...
//   await Future.wait([
//     _loadSettings(),
//     _loadCurrentPayment(), // Load current payment
//   ]);
...
//       _paymentShouldPay = payment; // Set initial value
//     });
//   } catch (e) {
...
//   _yearsMaxReservGroomFromOutClan = _settings['years_max_reserv_GroomFromOutClan'] ?? 1;
//   _yearsMaxReservGroomFromOriginClan = _settings['years_max_reserv_GrooomFromOriginClan'] ?? 3;
//   _paymentShouldPay = (_settings['payment_should_pay'] as num?)?.toDouble() ?? 0.0;
...
// final paymentValue = _settings['payment_should_pay'];
//   if (paymentValue != null) {
//     if (paymentValue is num) {
//       _paymentShouldPay = paymentValue.toDouble();
//       _currentPayment = paymentValue.toDouble();
//     } else if (paymentValue is String) {
//       _paymentShouldPay = double.tryParse(paymentValue) ?? 0.0;
//       _currentPayment = _paymentShouldPay;
//     } else {
//       _paymentShouldPay = 0.0;
//       _currentPayment = 0.0;
//     }
//   }
...
//   try {
//     // Save general settings (without payment)
//     final settingsData = {
...
//     );
//   }
// Widget _buildPaymentCard(bool isMobile, bool isTablet) {
//   return Container(
...
//               Expanded(
//                 child: Text(
//                   'المبلغ الحالي: ${_currentPayment.toStringAsFixed(0)} دج',
//                   style: TextStyle(
//                     fontSize: 14,
//                     fontWeight: FontWeight.w600,
//                     color: Colors.green.shade700,
...
//         _buildPaymentInputTile(
//           title: 'المبلغ المطلوب دفعه',
//           subtitle: 'المبلغ الذي يجب على العروس دفعه للحجز',
//           value: _paymentShouldPay,
//           onChanged: (value) => setState(() => _paymentShouldPay = value),
//           min: 0,
//           max: 100000,
//           step: 100,
...
// // ==== 8. UPDATE _buildSettingsForm() METHOD ====
// Widget _buildSettingsForm(bool isMobile, bool isTablet) {
//   return Column(
//     children: [
//       _buildGeneralSettingsCard(isMobile, isTablet),
//       SizedBox(height: 20),
//       _buildPaymentCard(isMobile, isTablet), // ADD THIS LINE
//       SizedBox(height: 20),
//       _buildInviteAcceptanceCard(isMobile, isTablet),
//       SizedBox(height: 20),
