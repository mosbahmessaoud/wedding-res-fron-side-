...
//                 const SizedBox(height: 16),
//                 Text(
//                   'لا توجد حجوزات منتهية الصلاحية',
//                   style: TextStyle(
//                       fontSize: 15,
...
//               Text('منتهي', style: TextStyle(fontSize: 8, color: Colors.grey.shade500)),
//             ],
//           ),
//         ),
//         title: Text(
