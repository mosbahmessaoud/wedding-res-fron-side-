...
//       filteredGrooms = List<Map<String, dynamic>>.from(grooms); // Create new list
//       isLoading = false;
//     });
    
//     // Apply filters AFTER state is set and widget is built
...
// // FIXED: Remove LayoutBuilder from _buildGroomCard - it causes grey screen on large screens
...
//   // Get screen size directly from MediaQuery
//   final screenWidth = MediaQuery.of(context).size.width;
//   final isSmallScreen = screenWidth < 600;
//   final isTablet = screenWidth >= 600 && screenWidth < 1024;
...
//             crossAxisAlignment: CrossAxisAlignment.start,
//             children: [
//               _buildHeaderSection(groom, isActive, groomId, isSmallScreen, avatarSize, titleFontSize),
//               SizedBox(height: isSmallScreen ? 12 : 16),
//               _buildInformationGrid(groom, isSmallScreen, isTablet),
//               SizedBox(height: isSmallScreen ? 16 : 20),
//               _buildActionButtons(groom, status, isActive, isSmallScreen, isTablet),
...
//     borderRadius: BorderRadius.circular(20),
//     child: Opacity(
//       opacity: isLoading ? 0.5 : 1.0, // Visual feedback when loading
//       child: Container(
//         padding: EdgeInsets.symmetric(horizontal: 12, vertical: 6),
//         decoration: BoxDecoration(
//           gradient: isSelected
