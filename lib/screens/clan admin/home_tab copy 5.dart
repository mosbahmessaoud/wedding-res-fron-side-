...
// // Update the _loadCalendarData() method to include clan info
...
//       // Create enriched reservation with groom data
//       final enrichedReservation = Map<String, dynamic>.from(reservation);
      
//       // FIXED: Get clan_id from reservation table, NOT from groom
//       enrichedReservation['reservation_clan_id'] = reservation['clan_id'];
      
//       // Add groom info if available
//       if (reservation['groom'] != null) {
//         enrichedReservation['first_name'] = reservation['groom']['first_name'];
//         enrichedReservation['last_name'] = reservation['groom']['last_name'];
//         enrichedReservation['father_name'] = reservation['groom']['father_name'];
//         enrichedReservation['phone_number'] = reservation['groom']['phone_number'];
//         enrichedReservation['guardian_name'] = reservation['groom']['guardian_name'];
//         enrichedReservation['guardian_phone'] = reservation['groom']['guardian_phone'];
//       }

//       if (date1 != null) {
//         validatedByDate.putIfAbsent(date1, () => []).add(enrichedReservation);
//       }
//       if (date2 != null) {
//         validatedByDate.putIfAbsent(date2, () => []).add(enrichedReservation);
//       }
//     }
...
//       if (date1 != null) {
//         pendingByDate.putIfAbsent(date1, () => []).add(enrichedReservation);
//       }
//       if (date2 != null) {
//         pendingByDate.putIfAbsent(date2, () => []).add(enrichedReservation);
//       }
//     }

//     // Process special reservations (rest remains the same)
...
//       specialMap[dateStr] = reservation;
//     }
...
//                     _buildCalendarOverview(isMobile, isTablet), // ADD THIS LINE
//                     SizedBox(height: isMobile ? 24 : 32),
...
// // Add this helper method to build the reservation card with clan info
...
//   // FIXED: Use reservation_clan_id instead of groom_clan_id
...
//         // Clan info section - FIXED: Use reservationClanId
