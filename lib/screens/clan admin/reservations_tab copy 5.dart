...
//                         SizedBox(width: 4),
//                         Text('حجزو في خارج العشيرة(${_belongPendingOutsideReservations.length + _belongValidatedOutsideReservations.length})'),
//                       ],
//                     ),
//                   ),
//                   Tab(
...
//                         SizedBox(width: 4),
//                         Text(' أتو من خارج العشيرة(${_notBelongPendingReservations.length + _notBelongValidatedReservations.length}) ' ),
//                       ],
//                     ),
//                   ),
...
//                         _buildBelongOutsideReservationsPage(isDark),// NEW
//                         _buildNotBelongReservationsPage(isDark), // NEW
...
//   final allNotBelong = [
//   ..._notBelongValidatedReservations.map((r) => 
//     Map<String, dynamic>.from({...r as Map, '_nb_status': 'validated'})),
//   ..._notBelongPendingReservations.map((r) => 
//     Map<String, dynamic>.from({...r as Map, '_nb_status': 'pending'})),
// ];

//   final List<Map<String, dynamic>> filtered = _searchQuery.isEmpty
//     ? allNotBelong
//     : allNotBelong.where((r) {
...
//                           ),
//                           Text(
//                             'عرسان من عشائر أخرى يحجزون في قاعات العشيرة',
//                             style: TextStyle(
...
//                 children: [
//                   Expanded(
//                     child: _buildNotBelongStatCard(
//                       'مؤكدة',
//                       _notBelongValidatedReservations.length,
...
//                     child: _buildNotBelongStatCard(
//                       'معلقة',
//                       _notBelongPendingReservations.length,
...
//                   _buildNotBelongReservationCard(reservation, isDark)),
//             ],
//           ),
//   );
// }
...
//   final statusColor = isValidated ? Colors.green.shade400 : Colors.orange.shade400;
//   final statusLabel = isValidated ? 'مؤكد' : 'معلق';
//   final statusIcon = isValidated ? Icons.check_circle_rounded : Icons.hourglass_empty_rounded;
//   final status = isValidated ? 'validated' : 'pending_validation';
...
//           {
//             ...reservation,
//             'phone_number': phone,        // ensure groom phone is top-level
...
//   final allBelongOutside = [
//     ..._belongValidatedOutsideReservations.map((r) =>
//         Map<String, dynamic>.from({...r as Map, '_nb_status': 'validated'})),
//     ..._belongPendingOutsideReservations.map((r) =>
//         Map<String, dynamic>.from({...r as Map, '_nb_status': 'pending'})),
//   ];

//   final List<Map<String, dynamic>> filtered = _searchQuery.isEmpty
//       ? allBelongOutside
//       : allBelongOutside.where((r) {
//           final q = _searchQuery.toLowerCase();
...
//                     const SizedBox(height: 16),
//                     Text(
//                       'لا يوجد أبناء عشيرة يحجزون خارجها',
//                       style: TextStyle(
//                           fontSize: 16,
//                           color: isDark ? Colors.grey.shade400 : Colors.grey.shade500,
//                           fontWeight: FontWeight.w500),
...
//                         shape: BoxShape.circle,
//                       ),
//                       child: const Icon(Icons.output, color: Colors.white, size: 24),
//                     ),
//                     const SizedBox(width: 12),
//                     Expanded(
//                       child: Column(
...
//                     child: _buildNotBelongStatCard(
//                       'مؤكدة',
//                       _belongValidatedOutsideReservations.length,
//                       Colors.green.shade400,
//                       Icons.check_circle_rounded,
//                       isDark,
//                     ),
...
//                     child: _buildNotBelongStatCard(
//                       'معلقة',
//                       _belongPendingOutsideReservations.length,
//                       Colors.orange.shade400,
//                       Icons.hourglass_empty_rounded,
//                       isDark,
//                     ),
...
//               ...filtered.map((reservation) =>
//                   _buildBelongOutsideReservationCard(reservation, isDark)),
//             ],
//           ),
//   );
// }
...
//         // ),
//         // const SizedBox(height: 16),
//         // // ACTION BUTTONS — use destination clan's required payment
//         // _buildOutsideActionButtons(
//         //   reservation,
//         //   status,
//         //   groomId,
//         //   reservationId,
