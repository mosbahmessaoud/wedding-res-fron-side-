...
//         padding: const EdgeInsets.only(bottom: 50), // Add space below button
...
//       locale: const Locale('ar', 'DZ'), // ADD THIS - Arabic locale for month names
...
//         Text(
//           selectedDate != null
//               ? DateFormat('dd/MM/yyyy').format(selectedDate!) // CHANGE THIS - no locale
//               : 'اختر التاريخ',
//           style: TextStyle(
//             color: isDark ? Colors.white : Colors.black87,
//             fontSize: 15,
