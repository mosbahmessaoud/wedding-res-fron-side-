      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 12),
            Text('بعد ختم وتوقيع جميع الجهات، توجّه إلى إدارة العشيرة التي تقيم فيها العرس', textAlign: TextAlign.center),
            // Text(originClanName, textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.w600)),
            Text('ليؤكدو حجزك في النظام', textAlign: TextAlign.center),
          ],
        ),
      ),
    ),
