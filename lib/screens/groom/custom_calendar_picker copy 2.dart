...
//         if (dateStr != null) {
//           validatedByDate.putIfAbsent(dateStr, () => []).add(reservation);
//         }
//       }
...
//         final dateStr = reservation['date1']?.toString();
//         if (dateStr != null) {
//           pendingByDate.putIfAbsent(dateStr, () => []).add(reservation);
//         }
//       }
...
//         return const Color(0xFF9C27B0); // Purple for mixed status
...
//                         (availability.status == DateStatus.available || 
...
//                     ),
//                   ),
//                   // Enhanced capacity indicator showing validated/pending split
...
//                   if (isCurrentMonth && availability.status == DateStatus.mixed)
//                     const Positioned(
//                       bottom: 2,
//                       left: 2,
//                       child: Icon(
...
//                   if (isCurrentMonth && (availability.status == DateStatus.massWeddingOpen || availability.allowMassWedding))
//                     const Positioned(
//                       bottom: 2,
//                       left: 2,
//                       child: Icon(
...
//                       (availability.status == DateStatus.reserved))
//                     const Positioned(
//                       top: 2,
//                       left: 2,
//                       child: Icon(
