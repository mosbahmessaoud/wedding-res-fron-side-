...
//   // / Replace the build method completely:
// @override
...
//             ? screenHeight - 20
//             : screenHeight - safeAreaPadding.top - safeAreaPadding.bottom - 40,
//           maxWidth: isLandscape ? screenWidth * 0.95 : double.infinity,
//         ),
//         decoration: BoxDecoration(
//           color: isDark 
...
//           mainAxisSize: MainAxisSize.min,
//           children: [
//             _buildModernHeader(screenWidth, screenHeight, isDark, isLandscape),
//             _buildMonthNavigation(screenWidth, screenHeight, isDark, isLandscape),
//             Flexible(
//               child: _buildCalendarGrid(screenWidth, screenHeight, isLandscape),
//             ),
//             _buildBottomSection(screenWidth, screenHeight, isDark, isLandscape),
//           ],
//         ),
//       ),
//     ),
...
// // Replace _buildModernHeader method:
// Widget _buildModernHeader(double screenWidth, double screenHeight, bool isDark, bool isLandscape) {
//   return Container(
//     padding: EdgeInsets.fromLTRB(
//       screenWidth * 0.05,
//       isLandscape ? screenHeight * 0.04 : screenHeight * 0.02,
//       screenWidth * 0.05,
//       isLandscape ? screenHeight * 0.02 : screenHeight * 0.015,
//     ),
//     decoration: BoxDecoration(
//       gradient: LinearGradient(
//         begin: Alignment.topLeft,
...
//               iconSize: isLandscape ? screenHeight * 0.05 : screenWidth * 0.05,
...
//                 style: TextStyle(
//                   color: Colors.white,
//                   fontSize: isLandscape ? screenHeight * 0.06 : screenWidth * 0.05,
//                   fontWeight: FontWeight.bold,
//                   letterSpacing: 0.5,
//                 ),
//                 maxLines: 1,
...
//               ? Center(
//                   child: SizedBox(
//                     width: isLandscape ? screenHeight * 0.05 : screenWidth * 0.05,
...
// // Replace _buildMonthNavigation method:
// Widget _buildMonthNavigation(double screenWidth, double screenHeight, bool isDark, bool isLandscape) {
//   return Container(
//     padding: EdgeInsets.symmetric(
...
//             padding: EdgeInsets.symmetric(
//               horizontal: screenWidth * 0.04,
//               vertical: isLandscape ? screenHeight * 0.015 : screenHeight * 0.01,
//             ),
//             decoration: BoxDecoration(
...
//                   style: TextStyle(
//                     fontSize: isLandscape ? screenHeight * 0.055 : screenWidth * 0.045,
//                     fontWeight: FontWeight.bold,
...
//                   color: isDark ? Colors.green.shade300 : Colors.green.shade800,
//                   size: isLandscape ? screenHeight * 0.06 : screenWidth * 0.05,
//                 ),
//               ],
//             ),
//           ),
...
//   );
// }
// // Replace _buildYearPicker method:
// Widget _buildYearPicker(double screenWidth, double screenHeight, bool isDark, bool isLandscape) {
//   final today = DateTime.now();
...
//                 'اختر السنة',
//                 style: TextStyle(
//                   fontSize: isLandscape ? screenHeight * 0.05 : screenWidth * 0.04,
//                   fontWeight: FontWeight.w600,
...
//                   style: TextStyle(
//                     fontSize: isLandscape ? screenHeight * 0.04 : screenWidth * 0.03,
//                     color: isDark 
...
//                   borderRadius: BorderRadius.circular(12),
//                   child: Container(
//                     width: isLandscape ? screenHeight * 0.25 : screenWidth * 0.2,
//                     decoration: BoxDecoration(
//                       gradient: isSelected
//                           ? LinearGradient(
//                               begin: Alignment.topLeft,
...
// // Replace _buildModernNavButton method:
// Widget _buildModernNavButton(IconData icon, VoidCallback onPressed, double screenWidth, double screenHeight, bool isDark, bool isLandscape) {
//   return Container(
//     decoration: BoxDecoration(
//       color: isDark 
...
//         onTap: onPressed,
//         child: Padding(
//           padding: EdgeInsets.all(isLandscape ? screenHeight * 0.025 : screenWidth * 0.02),
//           child: Icon(
//             icon,
//             color: isDark ? Colors.green.shade300 : Colors.green.shade700,
//             size: isLandscape ? screenHeight * 0.07 : screenWidth * 0.06,
//           ),
//         ),
//       ),
//     ),
...
// // Replace _buildCalendarGrid method:
// Widget _buildCalendarGrid(double screenWidth, double screenHeight, bool isLandscape) {
...
//                   Theme.of(context).brightness == Brightness.dark, isLandscape),
...
// // Replace _buildBottomSection method:
// Widget _buildBottomSection(double screenWidth, double screenHeight, bool isDark, bool isLandscape) {
//   return Container(
//     constraints: BoxConstraints(
//       maxHeight: isLandscape ? screenHeight * 0.4 : screenHeight * 0.28,
//     ),
//     decoration: BoxDecoration(
//       color: isDark 
...
//     ),
//     child: SingleChildScrollView(
//       padding: EdgeInsets.all(isLandscape ? screenHeight * 0.05 : screenWidth * 0.04),
//       child: Column(
//         mainAxisSize: MainAxisSize.min,
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
...
//             padding: EdgeInsets.symmetric(
//               horizontal: screenWidth * 0.04,
//               vertical: isLandscape ? screenHeight * 0.02 : screenHeight * 0.012,
//             ),
//             decoration: BoxDecoration(
//               color: isDark 
//                 ? Colors.green.shade900.withOpacity(0.3)
...
//                   size: isLandscape ? screenHeight * 0.055 : screenWidth * 0.045,
//                   color: isDark ? Colors.green.shade300 : Colors.green.shade700,
//                 ),
...
//                     style: TextStyle(
//                       fontSize: isLandscape ? screenHeight * 0.04 : screenWidth * 0.032,
//                       color: isDark ? Colors.green.shade300 : Colors.green.shade700,
//                       fontWeight: FontWeight.w500,
//                     ),
//                   ),
...
//             runSpacing: isLandscape ? screenHeight * 0.015 : screenHeight * 0.008,
//             children: [
//               _buildCompactLegend('متاح', const Color(0xFF4CAF50), screenWidth, screenHeight, isDark, isLandscape),
//               _buildCompactLegend('معلق', const Color(0xFFFFB74D), screenWidth, screenHeight, isDark, isLandscape),
//               _buildCompactLegend('محجوز', const Color(0xFFEF4444), screenWidth, screenHeight, isDark, isLandscape),
//               _buildCompactLegend('جماعي', const Color(0xFF00BCD4), screenWidth, screenHeight, isDark, isLandscape),
//               _buildCompactLegend('غير متاح', const Color(0xFFBDBDBD), screenWidth, screenHeight, isDark, isLandscape),
//             ],
//           ),
...
// // Replace _buildCompactLegend method:
// Widget _buildCompactLegend(String label, Color color, double screenWidth, double screenHeight, bool isDark, bool isLandscape) {
//   return Container(
//     padding: EdgeInsets.symmetric(
//       horizontal: screenWidth * 0.03,
//       vertical: isLandscape ? screenHeight * 0.025 : screenWidth * 0.015,
//     ),
//     decoration: BoxDecoration(
//       color: isDark 
...
//       children: [
//         Container(
//           width: isLandscape ? screenHeight * 0.03 : screenWidth * 0.025,
//           height: isLandscape ? screenHeight * 0.03 : screenWidth * 0.025,
//           decoration: BoxDecoration(
//             color: color,
//             shape: BoxShape.circle,
//           ),
...
// // Replace _buildActionButton method:
...
//         onTap: onTap,
//         child: Container(
//           height: isLandscape ? screenHeight * 0.08 : screenHeight * 0.055,
//           child: Center(
//             child: Text(
//               label,
//               style: TextStyle(
...
//                     ? Colors.white
//                     : (isDark ? Colors.green.shade300 : Colors.green.shade700),
//                 fontSize: isLandscape ? screenHeight * 0.045 : screenWidth * 0.038,
//                 fontWeight: FontWeight.w600,
//                 letterSpacing: 0.3,
//               ),
//             ),
