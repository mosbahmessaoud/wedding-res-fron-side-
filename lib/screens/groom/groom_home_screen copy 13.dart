...
// // REFACTORED METHOD - Now returns the hasPassword value:
// Future<bool> _checkAccessPassword() async {
//   try {
//     final hasPassword = await ApiService.hasAccessPassword();
//     setState(() {
//       _hasAccessPassword = hasPassword;
//     });
//     return hasPassword; // Return the value
//   } catch (e) {
...
// // UPDATED METHOD - Uses the return value from _checkAccessPassword:
// Future<bool> _verifyAccessForTab() async {
//   bool access = await _showAccessPasswordDialog();
//   return access;
// }
...
//       final hasAccess2 = await _verifyAccessForTab();
//       if (!hasAccess2) {
//         return;
//       }
//     }
...
//         // Check if trying to access Create Reservation tab (index 1)
//         if (index == 1 && !_hasValidReservation ) {
//           final hasAccess3 = await _verifyAccessForTab();
//           if (!hasAccess3) {
//             return;
//           }
//         }
...
//         // Check if trying to access Create Reservation tab (index 1)
//         if (index == 1 && !_hasValidReservation) {
//           final hasAccess4 = await _verifyAccessForTab();
//           if (!hasAccess4) {
