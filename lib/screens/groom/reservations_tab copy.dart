...
//                   ),
//                 ),
//                 if (showStatus) _buildStatusChip(reservation['status']),
//               ],
//             ),
...
//       // Download PDF from server using the API you provided
//       final Uint8List pdfBytes = await ApiService.downloadPdfFromServer(reservationId);
...
//               if (mounted) {
//                 ScaffoldMessenger.of(context).showSnackBar(
//                   const SnackBar(content: Text('يجب منح صلاحية الوصول للتخزين لحفظ الملف')),
//                 );
//               }
//               return;
//             }
