...
// 2. Update the _createClanAdmin method
...
// 3. Update the _showSuccessDialog method (remove the direct navigation)
void _showSuccessDialog() {
  showDialog(
    ...
    builder: (context) => AlertDialog(
      ...
      content: Text(
        'تم إنشاء حساب مدير العشيرة بنجاح. سيتم توجيهك لتأكيد رقم الهاتف.',
        style: TextStyle(
          fontSize: 16,
      ...
      actions: [
        ElevatedButton(
          onPressed: () {
            ...
            // Navigation to OTP screen is now handled in _createClanAdmin
          },
